...
export const SystemMessageType = {
    NOTIFY_GROUP_CHAT_CREATED: 10,
    NOTIFY_GROUP_CHAT_KICKED: 20,
    NOTIFY_GROUP_CHAT_ADD_MEMBER: 30,
    NOTIFY_GROUP_CHAT_USER_LEAVE_GROUP: 40,
    NOTIFY_GROUP_CHAT_ADMIN_RENAME_GROUP: 50,
