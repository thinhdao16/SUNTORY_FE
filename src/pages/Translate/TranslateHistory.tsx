        ...
        <div className="bg-white min-h-screen pt-4">
            <div className="flex items-center justify-between mb-4 px-6">
                ...
                <div className="relative" ref={moreMenuRef}>
                    ...
                    <div
                        className={`absolute right-0 top-8 bg-white rounded-lg shadow-lg z-50 transform transition-all duration-300 ease-out origin-top-right ${showMoreMenu ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'
                            }`}
                    >
                        <button
